      ...
      <div className="container py-5 flex flex-col items-center gap-8 justify-center font-raleway max-w-[580px]">
        <div className="flex flex-col p-5 pb-10 rounded-xl">
          <div className="bg-white p-5 rounded-xl mb-5">
            <div className="flex items-end justify-between mb-5 bg-white">
              <img src={Logo} alt="" width={50} />

              <h2 className="font-semibold w-[50px] flex flex-col text-[#022226] leading-3 uppercase text-sm text-center">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5 items-start justify-center">
            {data.questions.map((question) => (
              <div key={question._id} className="w-full">
                ...
                <div className="p-5 rounded-xl bg-white">
                  <h3
                    className={`${question.questionType === "text" ? "" : "mb-5 border-b border-gray-300 pb-2"} text-base font-medium text-gray-700`}
                  >
                    ...
                    >
                      {question.options.map((option) => (
                        <div key={option} className="flex items-center space-x-2">
                          ...
                          <Label className="text-gray-600 text-sm" htmlFor={option}>
                            {option}
                          </Label>
                        </div>
                      ))}
            ...
            <Button className="py-5 ml-auto text-sm bg-[#022226] hover:bg-[#022226]/70" disabled={isLoading} type="submit">
              Submit
            </Button>
          </form>
        </div>
